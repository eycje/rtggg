...
{
    background-image: url('/DXR.axd?r=0_1947-d_IRm');
...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_40-E_IRm');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_42-E_IRm');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_41-E_IRm');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_43-E_IRm');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
.dxeTBIncBtn_Moderno
{
	background-image: url('/DXR.axd?r=0_1934-d_IRm');
}
.dxeTBDecBtn_Moderno
{
	background-image: url('/DXR.axd?r=0_1930-d_IRm');
}
...
.dxeTBIncBtn_Moderno.dxEditors_edtTBIncBtnHover_Moderno
{
	background: #1d85cd url('/DXR.axd?r=0_1936-d_IRm');
	background: url('/DXR.axd?r=0_1936-d_IRm'), url(data:image/svg+xml;base64,);
	background: url('/DXR.axd?r=0_1936-d_IRm'), -ms-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1936-d_IRm'), -moz-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1936-d_IRm'), -o-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1936-d_IRm'), -webkit-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1936-d_IRm'), linear-gradient(to bottom, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
}
.dxeTBDecBtn_Moderno.dxEditors_edtTBDecBtnHover_Moderno
{
	background: #1d85cd url('/DXR.axd?r=0_1932-d_IRm');
	background: url('/DXR.axd?r=0_1932-d_IRm'), url(data:image/svg+xml;base64,);
	background: url('/DXR.axd?r=0_1932-d_IRm'), -ms-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1932-d_IRm'), -moz-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1932-d_IRm'), -o-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1932-d_IRm'), -webkit-linear-gradient(top, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
	background: url('/DXR.axd?r=0_1932-d_IRm'), linear-gradient(to bottom, rgba(29,133,205,1) 0%, rgba(8,108,179,1) 100%);
}
...
.dxeTBIncBtn_Moderno.dxEditors_edtTBIncBtnPressed_Moderno
{
	background-image: url('/DXR.axd?r=0_1937-d_IRm');
}
.dxeTBDecBtn_Moderno.dxEditors_edtTBDecBtnPressed_Moderno
{
	background-image: url('/DXR.axd?r=0_1933-d_IRm');
}
.dxeTBIncBtn_Moderno.dxEditors_edtTBIncBtnDisabled_Moderno
{
	background-image: url('/DXR.axd?r=0_1935-d_IRm');
}
.dxeTBDecBtn_Moderno.dxEditors_edtTBDecBtnDisabled_Moderno
{
	background-image: url('/DXR.axd?r=0_1931-d_IRm');
}
...
{
	background-image:  url('/DXR.axd?r=0_1942-d_IRm');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem_Moderno
{
	background-image:  url('/DXR.axd?r=0_1940-d_IRm');
}
.dxeTBVSys .dxeTBItem_Moderno 
{
	background-image:  url('/DXR.axd?r=0_1943-d_IRm');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem_Moderno
{
	background-image:  url('/DXR.axd?r=0_1941-d_IRm');
}
...
{
	background-image: url('/DXR.axd?r=0_1944-d_IRm');
}
.dxeTBVSys .dxeTBSmallTick_Moderno
{
	background-image: url('/DXR.axd?r=0_1945-d_IRm');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick_Moderno
{
	background-image: url('/DXR.axd?r=0_1938-d_IRm');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick_Moderno
{
	background-image: url('/DXR.axd?r=0_1939-d_IRm');
}
...
{
    background:  url('/DXR.axd?r=0_1929-d_IRm') no-repeat 50% center;
	padding: 2px 0;
}
...
{
	background-image: url('/DXR.axd?r=0_1998-d_IRm');
	height: 40px;
	width: 40px;
}
...
{
    background-image: url('/DXR.axd?r=0_1156-d_IRm');
    background-repeat: no-repeat;
    background-color: transparent;
}
.dxeButtonEditButtonHover_iOS .dxEditors_edtClear_iOS
...
{
	background-image:  url('/DXR.axd?r=0_1151-d_IRm');
    background-size: 2px 20px;
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem_iOS
{
	background-image:  url('/DXR.axd?r=0_1149-d_IRm');
    background-size: 1px 10px;
}
.dxeTBVSys .dxeTBItem_iOS 
{
	background-image:  url('/DXR.axd?r=0_1152-d_IRm');
    background-size: 20px 2px;
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem_iOS
{
	background-image:  url('/DXR.axd?r=0_1150-d_IRm');
...
{
	background-image: url('/DXR.axd?r=0_1153-d_IRm');
    background-size: 1px 10px;
}
.dxeTBVSys .dxeTBSmallTick_iOS
{
	background-image: url('/DXR.axd?r=0_1154-d_IRm');
    background-size: 10px 1px;
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick_iOS
{
	background-image: url('/DXR.axd?r=0_1147-d_IRm');
    background-size: 2px 48px;
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick_iOS
{
	background-image: url('/DXR.axd?r=0_1148-d_IRm');
...
{
	background-image: url('/DXR.axd?r=0_1223-d_IRm');
	height: 40px;
	width: 40px;
}
...
.dxeCalendarSelected_iOS
{
    background-image: url('/DXR.axd?r=0_1139-d_IRm');
    color: white;
}
.dxeCalendarToday_iOS
{
    background-image: url('/DXR.axd?r=0_1140-d_IRm');
}
.dxeDayInRange.dxeCalendarSelected_iOS
{
    background-image: url('/DXR.axd?r=0_1138-d_IRm');
}
.dxeCalendarSelected_iOS.dxeCalendarToday_iOS
{
    background-image: url('/DXR.axd?r=0_1142-d_IRm');
}
.dxeDayInRange.dxeCalendarSelected_iOS.dxeCalendarToday_iOS
{
    background-image: url('/DXR.axd?r=0_1141-d_IRm');
}
